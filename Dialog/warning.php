...
<html lang = "es">
	<head>
		...
		<style>
			...
			#dialogbox > div > #dialogboxhead{ background: #D6C98D; font-size:19px; padding:10px; color:#000; }
			#dialogbox > div > #dialogboxbody{ background:#BA7629; padding:20px; color:#FFF; }
			#dialogbox > div > #dialogboxfoot{ background: #D6C98D; padding:10px; text-align:right; }
		</style>
		...
		<script>
			...
			$(document).ready(function(){
				...
				Alert.render('La dirección de correo electrónico facilitada está actualmente en uso. <br> Por favor, emplee otra diferente.');
			});
		</script>
	</head> 
	<body>
